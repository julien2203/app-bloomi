...
-- Promo : 300 premières commandes payées, plafond 5 CHF (500 centimes) si tarif > 5 CHF.
...
-- Vérification rapide (compteur < 300 → promo plafond 5 CHF)
SELECT get_shipping_fee('letter_aplus') AS letter_aplus;
