...
export default function EditListingConditionScreen() {
              ...
              return (
                ...
                >
                  <View style={styles.optionText}>
                    ...
                    <Text variant="captionSm" color="textSecondary" style={styles.optionDescription}>
                      {item.description}
                    </Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  optionLabel: { ...theme.typography.body, color: theme.colors.textPrimary },
  optionLabelSelected: {
    color: theme.colors.textPrimary,
