...
export default function EditListingPriceScreen() {
  ...
  const handleConfirm = () => {
    ...
    setField('draftPriceText', trimmed);
    router.back();
  };
...
const styles = StyleSheet.create({
  ...
  label: { ...theme.typography.body, color: theme.colors.textPrimary, marginBottom: 6 },
  input: { ...theme.typography.body, color: theme.colors.textPrimary, paddingVertical: 6 },
  footer: {
    paddingHorizontal: theme.spacing.horizontalPadding,
    paddingTop: 12,
    borderTopWidth: 1,
